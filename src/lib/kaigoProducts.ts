...
export const kaigoProducts: KaigoProduct[] = [
  ...
  },
  {
    id: "p52",
    type: "single",
    title: "高齢親の思い出・家族の歴史 書き留めメモ テンプレート集",
    description:
      "親が話してくれた思い出、生い立ち、家族の節目、次に聞きたいことを、家族内で見返せる形に少しずつ残すPDF/Excelセット。",
    priceLabel: "単品 1,480円",
    boothUrl: "https://kaigo-okane.booth.pm/items/8436039",
  ...
  },
  {
    id: "p57",
    type: "single",
    title: "実家の法事・年忌予定 書き留めメモ テンプレート集",
    description:
      "確認済みの法事・年忌予定、命日、過去の法要記録、家族で次に確認したいことを家族内で見返しやすくするPDF/Excelセット。",
    priceLabel: "単品 1,480円",
    boothUrl: "https://kaigo-okane.booth.pm/items/8383072",
